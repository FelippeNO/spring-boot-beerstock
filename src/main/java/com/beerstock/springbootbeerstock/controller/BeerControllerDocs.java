...
public interface BeerControllerDocs {
    ...
    @ApiResponses(value = {@ApiResponse(code = 201, message =
            "Success beer " + "creation"), @ApiResponse(code = 400, message =
    ...
    @ApiResponses(value = {@ApiResponse(code = 200, message =
            "Success beer " + "found in the system"), @ApiResponse(code = 404
            , message = "Beer " + "with given name not found.")})
    BeerDTO findByName(@PathVariable String name) throws BeerNotFoundException;

    @ApiOperation(value = "Returns a list of all beers registered in the " +
            "system")
    @ApiResponses(value = {@ApiResponse(code = 200, message =
            "List of all " + "beers registered in the system"),})
    List<BeerDTO> listBeers();

    @ApiOperation(value = "Delete a beer found by a given valid Id")
    @ApiResponses(value = {@ApiResponse(code = 204, message =
            "Success beer " + "deleted in the system"), @ApiResponse(code =
            404, message = "Beer with given id not found.")})
